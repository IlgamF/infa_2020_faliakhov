...
rules2 = Label(root, text='Стреляй правой и левой кнопками мыши', font="Arial 15", bg="white", fg="blue")
...
rules5 = Label(root, text='Используй "a" и "d", чтобы двигаться', font="Arial 15", bg="white", fg="blue")
rules6 = Label(root, text='Чтобы начать, нажми "начать"', font="Arial 15", bg="white", fg="blue")
rules1.place(x=70, y=100)
rules2.place(x=70, y=150)
rules3.place(x=90, y=175)
rules4.place(x=90, y=200)
rules5.place(x=80, y=225)
rules6.place(x=100, y=250)
